...
func Load() *Config {
	...
	return &Config{
		...
		OpenAIModel:        envOr("OPENAI_MODEL", "o3"),
		...
		OpenRouterGeminiModel: envOr("OPENROUTER_GEMINI_MODEL", "google/gemini-2.5-pro"),
		OpenRouterCodexModel:  envOr("OPENROUTER_CODEX_MODEL", "openai/o3"),
